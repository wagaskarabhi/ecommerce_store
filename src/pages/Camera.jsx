...
const Camera = () => {
  ...
  // Filter Camera based on the selected category
  const filteredCameraData =
    filterCompany === "all"
      ? productData.filter((product) => product.type === "camera")
      : productData.filter(
          (product) =>
    ...
    <>
      ...
      <div className="mb-4 flex w-50 h-20 ">
        ...
        <button
          ...
          onClick={() => handleCompanyFilter("Canon")}
        >
          Canon
        </button>
        <button
          ...
          onClick={() => handleCompanyFilter("leica")}
        >
          Leica
        </button>
        ...
        <button
          ...
          onClick={() => handleCompanyFilter("Sony")}
        >
          Sony
        </button>
        <button
          ...
          onClick={() => handleCompanyFilter("lumix")}
        >
          Lumix
        </button>
        <button
          ...
          onClick={() => handleCompanyFilter("nikon")}
        >
          Nikon
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
        {filteredCameraData.map((product) => (
          <div
